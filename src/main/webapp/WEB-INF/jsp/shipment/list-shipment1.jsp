...
<script src="/resources/js/shipment/ShipmentManager1.js"></script>
...
<script>
    ...
    shipmentManager1.initProvince('${province.id}', '${province.name}');
    </c:forEach>
    ...
    function filterType(goodsTypeId, type) {
        shipmentManager1.filter(goodsTypeId, type);
