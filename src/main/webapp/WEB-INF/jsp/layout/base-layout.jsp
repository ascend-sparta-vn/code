...
<body class="header-fixed header-fixed-space-default">
	<div class="wrapper">
		...
		<!-- to get spring:message in common.js -->
		<c:set var="province_from_choose"><spring:message code="province.from.choose"/></c:set>
		<c:set var="district_from_choose"><spring:message code="district.from.choose"/></c:set>
		<c:set var="trucking_goods_type_choose"><spring:message code="trucking.goods.type.choose"/></c:set>
		<c:set var="trucking_type_choose"><spring:message code="trucking.type.choose"/></c:set>
		<c:set var="shipment_dealType_choose"><spring:message code="shipment.dealType.choose"/></c:set>
		<c:set var="trucking_choose"><spring:message code="trucking.choose"/></c:set>
		
		<input id="province_from_choose" type="hidden" value='${province_from_choose}'/>
		<input id="district_from_choose" type="hidden" value='${district_from_choose}'/>
		<input id="trucking_goods_type_choose" type="hidden" value='${trucking_goods_type_choose}'/>
		<input id="trucking_type_choose" type="hidden" value='${trucking_type_choose}'/>
		<input id="shipment_dealType_choose" type="hidden" value='${shipment_dealType_choose}'/>
		<input id="trucking_choose" type="hidden" value='${trucking_choose}'/>
