...
<div class="breadcrumbs">
	<div class="container">
		<h1 class="pull-left"><spring:message code="trucking.post"/></h1>
		<ul class="pull-right breadcrumb">
			<li><a href="/"><spring:message code="homepage"/></a></li>
			<li><a href="/trucking/list-trucking"><spring:message code="trucking.manager"/></a></li>
			<li class="active">
				<%-- 						<a href="/trucking/post"><spring:message code="trucking.post"/></a> --%>
				<spring:message code="trucking.post"/>
			</li>
		</ul>
	</div>
</div>
...
<div class="container content profile">
	<div class="row">
		...
		<div class="col-md-9" id="post-trucking-new">
			<div class="sky-form">
				<header><spring:message code="trucking.post.info"/></header>
				<fieldset>
					<div class="row">
						...
						<section class="col col-3">
							<div class="form-group">
								...
								<div style="text-align: center">
									<button id="addTruckBtn" class="btn rounded btn-primary btn-u-sm form-control" style="color: white;" type="button">
										<i class="fa fa-plus-square"></i>&nbsp<spring:message code="truck.btn.add"/></button>
								</div>
							</div>
						</section>
					</div>
				...
				<fieldset>
					<div class="row">
						<section class="col col-6">
							<div class="form-group">
								<label class=""><spring:message code="trucking.title"/></label>
								<div class="input-group ">
...
<%@ include file="/WEB-INF/jsp/modal/trucking-modal.jsp" %>
...
<script>
    ...
    $(document).ready(function(){
        $("#profile-menu-3").addClass("active");
