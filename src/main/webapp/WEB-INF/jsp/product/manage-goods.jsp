	...
	<div class="row">
		...
		<div class="col-md-9">
			<div class="tag-box tag-box-v3 form-page">
				<div class="headline">
					<h2 class="label-headline"><spring:message code="goods.list" /></h2>
				</div>
				<div class="row">
...
<script>
	...
	<c:forEach items="${listProvince}" var="province">
		goodsManager.initProvince('${province.id}', '${province.name}');
	</c:forEach>
	...
	function editGoods(id) {
		window.location.href = '/shipment/edit-goods/' + id;
	}
