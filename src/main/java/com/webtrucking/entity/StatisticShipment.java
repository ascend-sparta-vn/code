...
@Entity
@Table(name = "statistic_shipment")
public class StatisticShipment {
	...
	public StatisticShipment(int id, int objectType, String objectName, int objectId, int objectQuantity) {
		super();
		this.id = id;
		this.objectType = objectType;
		this.objectName = objectName;
