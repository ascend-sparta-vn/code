...
<div class="breadcrumbs">
			<div class="container">
				<h1 class="pull-left"><spring:message code="trucking.trucking.list"/></h1>
				<ul class="pull-right breadcrumb">
					<li><a href="/"><spring:message code="homepage"/></a></li>
					<li class="active">
					<spring:message code="trucking.trucking.list"/>
<%-- 					<a href="/trucking/list-trucking"><spring:message code="trucking.trucking.list"/></a> --%>
					</li>
				</ul>
			</div>
		</div>
...
<script src="/resources/js/trucking/TruckingManager.js"></script>
...
<script>
var truckingManager = new TruckingManager();
<c:forEach items="${listProvince}" var="province">
	truckingManager.initProvince('${province.id}', '${province.name}');
</c:forEach>
