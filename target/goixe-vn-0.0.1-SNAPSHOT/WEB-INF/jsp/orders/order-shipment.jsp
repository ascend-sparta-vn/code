...
<div class="breadcrumbs">
	<div class="container">
		<h1 class="pull-left"><spring:message code="order.shipment.manage"/></h1>
		<ul class="pull-right breadcrumb">
			<li><a href="/"><spring:message code="homepage"/></a></li>
			<li><a href="/order/shipment"><spring:message code="order.shipment.manage"/></a></li>
<!-- 			<li class="active"> -->
<%-- 				<spring:message code="order.shipment.detail"/> --%>
			...
			<div class="container content-sm col-lg-12">
				...
				<div class="table-search-v1 margin-bottom-30">
					<div class="table-responsive">
						<table class="table table-bordered table-striped" id="orderShipmentTable">
							<thead>
								<tr>
...
<script src="/resources/js/orders/OrderShipmentManager.js"></script>
<script>
var manager = new OrderShipmentManager();
...
$(document).ready(function(){
	$("#profile-menu-8").addClass("active");
...
function deleteOrderShipment(id) {
	manager.deleteOrderShipment(id);
}
</script>
