...
INSERT INTO `api_configuration` (`api_id`,`name`,`url`,`request`,`response`,`method`) VALUES (1,'1.1.Call get OTP register API\n','https://alp-api-internal.tmn-dev.com/hackathon/v1/wallet/register/get-otp/976686535',NULL,'{ \"status_code\": \"200\", \"status_message\": \"success\", \"data\": { \"mobile_number\": \"${mobile_number}\", \"otp_reference\": \"${otp_reference}\" } }\n','GET');
