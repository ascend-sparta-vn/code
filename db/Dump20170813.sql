...
INSERT INTO `user` VALUES (1,'admin','admin@onmart.com','123456','19008686',NULL,1,'2017-08-12 17:28:18','2017-08-12 17:28:18'),(2,'customer','customer@onmart.com','123456','0987654321',NULL,2,'2017-08-12 17:28:18','2017-08-12 17:28:18'),(3,'provider','provider@onmart.com','123456','0987651234',NULL,3,'2017-08-12 17:28:18','2017-08-12 17:28:18'),(4,'transporter','transporter@onmart.com','123456','0987658686',NULL,4,'2017-08-12 17:28:18','2017-08-12 17:28:18');
...
INSERT INTO `api_configuration` (`api_id`,`name`,`url`,`request`,`response`,`method`) VALUES (1,'1.1.Call get OTP register API\n','https://alp-api-internal.tmn-dev.com:5678/hackathon/v1/wallet/register/get-otp/976686535',NULL,'{ \"status_code\": \"200\", \"status_message\": \"success\", \"data\": { \"mobile_number\": \"${mobile_number}\", \"otp_reference\": \"${otp_reference}\" } }\n','GET');
INSERT INTO `api_configuration` (`api_id`,`name`,`url`,`request`,`response`,`method`) VALUES (2,'1.2.Call confirm OTP register API\n','https://alp-api-internal.tmn-dev.com/hackathon/v1/wallet/register/confirm-otp','{ \"otp_code\" : \"#otp_code#\", \"otp_reference\" : \"#otp_reference#\", \"mobile_number\" : \"#mobile_number#\" }\n','{ \"status_code\": \"200\", \"status_message\": \"success\", \"data\": { \"token\": \"#token#\", \"otp_result\": #otp_result# } } \n','POST');
INSERT INTO `api_configuration` (`api_id`,`name`,`url`,`request`,`response`,`method`) VALUES (3,'1.3.Call create profile API\n','https://alp-api-internal.tmn-dev.com:5678/hackathon/v1/wallet/register/create-profile','{ \"thai_id\": \"#thai_id#\", \"first_name\": \"#first_name#\", \"last_name\": \"#last_name#\", \"postal_code\": \"#postal_code#\", \"mobile_number\": \"#mobile_number#\", \"device_os\": \"#device_os#\", \"password\": \"#password#\", \"email\": \"#email#\", \"address\": \"#address#\", \"occupation\": \"#occupation#\" }\n','{ \"status_code\": \"200\", \"status_message\": \"success\", \"data\": { \"mobile_number\": \"0050000002\", \"email\": \"ascender@gmail.com\", \"thai_id\": \"3231744035655\", \"password\": \"\", \"first_name\": \"Ascend\", \"last_name\": \"Hackathon\", \"address\": \"89 AIA Dindang, Bangkok\", \"postal_code\": \"10400\", \"occupation\": \"แม่บ้าน\", \"channel_id\": 46, \"error_message\": null } }\n','POST');
INSERT INTO `api_configuration` (`api_id`,`name`,`url`,`request`,`response`,`method`) VALUES (4,'2.1.Sign-In Wallet account API\n','https://alp-api-internal.tmn-dev.com:5678/hackathon/v1/wallet/sign-in','{ \"username\":\"#username#\", \"password\":\"#password#\" }\n','{ \"status_code\":\"200\", \"status_message\":\"success\", \"data\":{ \"occupation\":\"occupation\", \"birthdate\":\"19910920\", \"tmn_id\":\"tmn.99999999999\", \"mobile_number\":\"0999999999\", \"profile_image_status\":\"false\", \"current_balance\":\"999999.99\", \"lastname_en\":\"Skywalker\", \"has_password\":true, \"access_token\":\"ef2d69fe-49c7-4b30-9a1e-d9b5ab0a6b41\", \"title\":\"นาย\", \"thai_id\":\"9999999999999\", \"profile_type\":\"consumer\", \"firstname_en\":\"Anakin\", \"address_list\":[ { \"address\":\"999 ประเวศ ประเวศ\", \"province\":\"กทม\", \"postal_code\":\"10200\", \"address_id\":137592 }, { \"address\":\"998\", \"province\":\"กรุงเทพมหานคร\", \"postal_code\":\"10310\", \"address_id\":139680 } ], \"image_url\":\"https://s3-ap-southeast-1.amazonaws.com/profile-images-alpha/tmn.10000001502_0764636f833343859fe6e1086022455b.jpg\", \"fullname\":\"Anakin Skywalker\", \"force_kyc\":false, \"email\":\"anakin.sky@ascendcorp.com\", \"kyc_verify_status\":true, \"has_pin\":true } }\n','POST');
INSERT INTO `api_configuration` (`api_id`,`name`,`url`,`request`,`response`,`method`) VALUES (5,'2.2. Sign-Out Wallet account API\n','https://alp-api-internal.tmn-dev.com:5678/hackathon/v1/wallet/sign-out',NULL,'{ \"status_code\": \"200\", \"status_message\": \"success\", \"data\": { \"message\": \"Sign out is successful\" } }\n','POST');
INSERT INTO `api_configuration` (`api_id`,`name`,`url`,`request`,`response`,`method`) VALUES (6,'3.1. Get user profile\n','https://alp-api-internal.tmn-dev.com:5678/hackathon/v1/wallet/user/profile?device_os=%s&app_version=%s',NULL,'{ \"status_code\": \"200\", \"status_message\": \"success\", \"data\": { \"occupation\": \"พนักงานเอกชน\", \"birthdate\": \"19820118\", \"tmn_id\": \"tmn.10000001502\", \"mobile_number\": \"0909038288\", \"profile_image_status\": \"false\", \"current_balance\": \"10059.5\", \"lastname_en\": \"Terakamjay\", \"has_password\": true, \"access_token\": null, \"title\": \"นาย\", \"thai_id\": \"3209900453291\", \"profile_type\": \"consumer\", \"firstname_en\": \"Norawich\", \"address_list\": [ { \"address\": \"address ดินแดง ดินแดง\", \"province\": \"กรุงเทพมหานคร\", \"postal_code\": \"10400\", \"address_id\": 137592 }, { \"address\": \"18\", \"province\": \"กรุงเทพมหานคร\", \"postal_code\": \"10310\", \"address_id\": 139680 } ], \"image_url\": \"https://s3-ap-southeast-1.amazonaws.com/profile-images-alpha/tmn.10000001502_0764636f833343859fe6e1086022455b.jpg\", \"fullname\": \"นรวิช ธีระกำจาย\", \"force_kyc\": false, \"email\": \"user1.test.v1@gmail.com\", \"kyc_verify_status\": true, \"has_pin\": true } }\n','GET');
INSERT INTO `api_configuration` (`api_id`,`name`,`url`,`request`,`response`,`method`) VALUES (7,'3.2. Get user balance\n','https://alp-api-internal.tmn-dev.com:5678/hackathon/v1/wallet/user/balance?device_os=ios&app_version=2.0',NULL,'{ \"status_code\": \"200\", \"status_message\": \"success\", \"data\": { \"current_balance\": \"10059.50\" } }\n','GET');
INSERT INTO `api_configuration` (`api_id`,`name`,`url`,`request`,`response`,`method`) VALUES (8,'4.1. Topup money to Wallet account API\n','https://alp-api-internal.tmn-dev.com/hackathon/v1/wallet/top-up','{ \"mobile_number\":\"0875793999\", \"amount\":\"30\" }\n','{ \"status_code\": \"200\", \"status_message\": \"Topup success\" }\n','POST');
INSERT INTO `api_configuration` (`api_id`,`name`,`url`,`request`,`response`,`method`) VALUES (9,'4.2.1.Call draft transaction transfer API\n','https://alp-api-internal.tmn-dev.com/hackathon/v1/wallet/transfer/draft-transaction','{ \"amount\": \"1.00\", \"mobileNumber\" : \"0855555555\" } \n','{ \"status_code\": \"200\", \"status_message\": \"success\", \"data\": { \"amount\": 1, \"draft_transaction_id\": \"584f0e90-a886-4d34-b850-40bc1af22bbd\", \"recipient_name\": \"zcvbn***\", \"mobile_number\": \"085-555-5555\", \"recipient_image_url\": \"https://s3-ap-southeast-1.amazonaws.com/profile-images-alpha/\" } }\n','POST');
INSERT INTO `api_configuration` (`api_id`,`name`,`url`,`request`,`response`,`method`) VALUES (10,'4.2.2.Call send OTP transfer API\n','https://alp-api-internal.tmn-dev.com/hackathon/v1/wallet/transfer/get-otp','{ \"personalMessage\": \"Sample transfer\" }\n','{ \"status_code\": \"200\", \"status_message\": \"success\", \"data\": { \"draft_transaction_id\": \"584f0e90-a886-4d34-b850-40bc1af22bbd\", \"amount\": 1, \"otp_ref_code\": \"XNVZ\", \"mobile_number\": \"0909038288\" } }\n','POST');
INSERT INTO `api_configuration` (`api_id`,`name`,`url`,`request`,`response`,`method`) VALUES (11,'4.2.3.Call confirm OTP transfer API\n','https://alp-api-internal.tmn-dev.com/hackathon/v1/wallet/transfer/confirm-otp','{ \"mobile_number\": \"0909038288\", \"otp_ref_code\": \"YPYM\", \"otp_string\": \"123456\" }\n','{ \"status_code\": \"200\", \"status_message\": \"success\", \"data\": { \"confirm_status\" : \"Confirmed\" } }\n','POST');
INSERT INTO `api_configuration` (`api_id`,`name`,`url`,`request`,`response`,`method`) VALUES (12,'4.2.4.Get status of transfer API ','https://alp-api-internal.tmn-dev.com/hackathon/v1/wallet/transfer/status',NULL,'{ \"status_code\": \"200\", \"status_message\": \"success\", \"data\": { \"transfer_status\": \"CONFIRMED\" } }\n','GET');
INSERT INTO `api_configuration` (`api_id`,`name`,`url`,`request`,`response`,`method`) VALUES (13,'4.2.5. Get detail of transfer API','https://alp-api-internal.tmn-dev.com/hackathon/v1/wallet/transfer/detail',NULL,'{ \"status_code\": \"200\", \"status_message\": \"success\", \"data\": { \"amount\": 1, \"recipient_name\": \"zcvbn***\", \"personal_message\": \"Sample transfer\", \"current_balance\": 9364.21, \"mobile_number\": \"085-555-5555\", \"transaction_id\": \"50000000663324\", \"recipient_image_url\": \"https://s3-ap-southeast-1.amazonaws.com/profile-images-alpha/\", \"transaction_date\": \"02/08/2017 16:49\" } }\n','GET');
INSERT INTO `api_configuration` (`api_id`,`name`,`url`,`request`,`response`,`method`) VALUES (14,'5.1. Pay barcode at Retail','https://alp-api-internal.tmn-dev.com/hackathon/v1/wallet/pay-at-retail/barcode?device_os=ios&app_version=2.0',NULL,'{ \"status_code\": \"200\", \"status_message\": \"success\", \"data\": { \"request_id\": \"170802104020723854\", \"mobile_number\": \"0909038288\", \"barcode\": { \"created\": \"2017-08-02T10:40:20+07:00\", \"expiry_date\": \"2017-08-02T10:55:20+07:00\", \"payment_code\": \"00005022967185\" }, \"application_requestor\": \"Wallet\", \"tmn_id\": \"tmn.10000001502\", \"request_datetime\": \"Wed Aug 02 10:40:20 ICT 2017\" } }\n','GET');
INSERT INTO `api_configuration` (`api_id`,`name`,`url`,`request`,`response`,`method`) VALUES (15,'5.2. List all user\'s transaction history in TMW\n','https://alp-api-internal.tmn-dev.com/hackathon/v1/wallet/transactions/history?startDate=2017-08-17&endDate=2017-08-19&page=1&limit=3',NULL,'{ \"status_code\": \"200\", \"status_message\": \"success\", \"data\": { \"total\": 6, \"activities\": [ { \"report_id\": \"1632795\", \"original_type\": \"buy_cashcard\", \"type\": \"ซื้อบัตรเงินสดทรูมันนี่\", \"amount\": \"-1,000.00\", \"title\": \"บัตรเงินสดทรูมันนี่\", \"reference\": \"090-903-8288\", \"logo_url\": \"https://s3-ap-southeast-1.amazonaws.com/bill-logo.tewm-alpha/ecash@2x.png\", \"date_time\": \"17/08/17 14:58\", \"original_action\": \"ecash_c\" }, { \"report_id\": \"1632790\", \"original_type\": \"add_money\", \"type\": \"เติมเงิน Wallet\", \"amount\": \"+150.00\", \"title\": \"บัญชีธนาคาร\", \"reference\": \"ธนาคารไทยพาณิชย์\", \"logo_url\": \"https://ext.truemoney.com/m/images/logo_bank/scb@2x.png\", \"date_time\": \"17/08/17 14:58\", \"original_action\": \"debit_scb\" }], \"total_page\": 2, \"limit\": 3, \"current_page\": 1 } }\n','GET');
